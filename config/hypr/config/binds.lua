...
-- Live cross-workspace window overview (provided by hyprwinview)
hl.bind(mainMod .. " + O", function()
	hl.plugin.hyprwinview.overview("toggle")
end)
...
-- Resize the active scrolling column
...
-- Move the active window to a monitor by direction
hl.bind(mainMod .. " + ALT + SHIFT + Left", hl.dsp.window.move({ monitor = "l" }))
hl.bind(mainMod .. " + ALT + SHIFT + Right", hl.dsp.window.move({ monitor = "r" }))
...
hl.bind(mainMod .. " + grave", hl.dsp.exec_cmd("/usr/bin/pypr toggle term"))
