...
-- Pyprland terminal scratchpad
hl.window_rule({
    match     = { class = "^(pypr-term)$" },
    float     = true,
    workspace = "special:S-term silent",
    size      = { "monitor_w*0.80", "monitor_h*0.60" },
})
...
hl.window_rule({ match = { class = "^(com\\.mitchellh\\.ghostty|ghostty)$" }, tag = "+hyprglass_enabled" })
